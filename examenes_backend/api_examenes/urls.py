...
from .views import (
    DoctorViewSet, PacienteViewSet, ExamenViewSet, AcompananteViewSet, HistorialPacienteAPIView,
...
urlpatterns = [
    ...
    path('historial/', HistorialPacienteAPIView.as_view(), name='historial-paciente'),
]